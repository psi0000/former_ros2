...
def generate_launch_description():
    ...
    bt_publisher_port = LaunchConfiguration('bt_publisher')
    bt_server_port = LaunchConfiguration('bt_server')
    ...
    param_substitutions = {
        ...
        'robot_id': namespace,
        'groot_zmq_publisher_port': bt_publisher_port,
        'groot_zmq_server_port': bt_server_port}
    ...
    return LaunchDescription([
        ...
        # Node(
        #     package='nav2_intention',
        #     executable='intention_server',
        #     name='intention_server',
        #     output='screen',
        #     parameters=[configured_params],
        #     remappings=costmap_remapping),
