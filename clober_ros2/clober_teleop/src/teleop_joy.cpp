...
#include "clober_teleop/teleop_joy.hpp"

CloberTeleop::CloberTeleop(const std::string& node)
  : Node(node)
  , axis_linear_x_(1)
  , axis_linear_y_(0)
  , axis_angular_(3)
...
void CloberTeleop::joyCallback(const sensor_msgs::msg::Joy::SharedPtr& msg)
{
...
void CloberTeleop::changeSpeed(const sensor_msgs::msg::Joy::SharedPtr& msg)
{
...
void CloberTeleop::publishCmdVel(const sensor_msgs::msg::Joy::SharedPtr& msg)
{
...
int main(int argc, char** argv)
{
  ...
  auto node = std::make_shared<CloberTeleop>("teleop_node");
