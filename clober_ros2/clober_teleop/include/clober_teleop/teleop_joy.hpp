...
#ifndef CLOBER_TELEOP__TELEOP_JOY_HPP_
#define CLOBER_TELEOP__TELEOP_JOY_HPP_
...
class CloberTeleop : public rclcpp::Node
{
public:
  CloberTeleop(const string& node);

  virtual ~CloberTeleop() = default;
...
#endif  // CLOBER_TELEOP__TELEOP_JOY_HPP_