...
#ifndef FORMER_HARDWARE__FORMER_HAREWARE_HPP_
#define FORMER_HARDWARE__FORMER_HAREWARE_HPP_
...
#include "former_msgs/msg/feedback.hpp"
#include "former_msgs/srv/set_led.hpp"
#include "former_hardware/visibility_control.h"

namespace former_hardware
{
class FormerHardware : public hardware_interface::BaseInterface<hardware_interface::SystemInterface>
{
public:
  RCLCPP_SHARED_PTR_DEFINITIONS(FormerHardware)

  FORMER_HARDWARE_PUBLIC
...
private:
  ...
  /// rosservice
  rclcpp::Client<former_msgs::srv::SetLed>::SharedPtr srv_led_;

  /// rostopic
  rclcpp::Publisher<former_msgs::msg::Feedback>::SharedPtr pub_feedback_;
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr pub_estop_;
  std::shared_ptr<realtime_tools::RealtimePublisher<former_msgs::msg::Feedback>> rp_feedback_;
...
#endif  // FORMER_HARDWARE__FORMER_HAREWARE_HPP_